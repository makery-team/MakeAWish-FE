...
const styles = StyleSheet.create({
  ...
  collapsedTitle: { fontSize: 14, color: theme.colors.text, letterSpacing: -0.5 },
  ...
  headerTitle: { fontSize: 18, color: theme.colors.text, letterSpacing: -0.5 },
  ...
  toggleText: { fontSize: 10, color: theme.colors.textMuted, letterSpacing: -0.3 },
  ...
  gridBtnText: { fontSize: 10, color: theme.colors.text, letterSpacing: -0.3 },
  ...
  summaryTitle: { fontSize: 15, color: theme.colors.text, marginBottom: 16, letterSpacing: -0.5 },
  ...
  confirmBtnTextPrimary: { color: 'white', fontSize: 15, letterSpacing: -0.5 },
  ...
  confirmBtnTextSecondary: { color: theme.colors.textMuted, fontSize: 15, letterSpacing: -0.5 },
  ...
  paymentPrice: { fontSize: 28, color: theme.colors.text, textAlign: 'center', marginBottom: 20, letterSpacing: -1 },
  ...
  paymentBtnText: { color: 'white', fontSize: 16, letterSpacing: -0.5 },
});
